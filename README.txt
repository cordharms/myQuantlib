...
2) Include Boost into VS 2012
   ...
   A template sheet is located  in quantlib-old/.
   Copy the template to Microsoft.Cpp.Win32.Boost.props and edit it in a text editor
   and update paths to your local Boost installation
